...
- **Sidecar (shadownet-local)** — A2A transport, Ed25519 identity, JWT-EdDSA mutual auth, contact graph, per-contact grants, SQLite history, MCP control surface. Single-tenant. Working.
...
| Code | Enable WAL mode in shadownet-local. |
