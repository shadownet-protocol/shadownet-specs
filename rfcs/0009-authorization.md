...
| `mcp:tools.write` | The `social_send`, `social_respond`, `social_coordinate`, `social_confirm_plan`, `social_accept_plan`, `social_add_contact`, `social_grant`, `social_set_contact_profile`, `social_quarantine_review` MCP tools, and any future state-mutating tools. |
...
```json
{
  ...
  "supported_features": ["mcp", "inbox-wait", "bundle", "connect-url", "oauth-authorize"],
  "...": "..."
}
```
